...
import com.steven.scan.client.DecodeFormatManager;
import com.steven.scan.client.DecodeHintManager;
...
public class DecoratedBarcodeView extends FrameLayout {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        TypedArray attributes = getContext().obtainStyledAttributes(attrs, R.styleable.DecoratedBarcodeView);
